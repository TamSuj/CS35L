        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            <section className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow mt-6">
                ...
                <form>
                    ...
                    <button type="submit"
                            className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit
                    </button>
                </form>
